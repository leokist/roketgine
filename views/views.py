...
def resultado():
    ...
    raz_eq = request.form.get('raz_eq')
    comb = eval(request.form.get('comb'))
    oxid = eval(request.form.get('oxid'))
    pressao_camara = request.form.get('pressao_camara')
    pressao_ambiente = request.form.get('pressao_externa')
    comp_caract = request.form.get('comp_caract')
    forca_empuxo = request.form.get('forca_empuxo')
    tipo_bocal = request.form.get('tipo_bocal')
    ...
    if motor.status_reacao == "erro":
        return redirect(url_for('resultado_erro'))
    else:
        return render_template('principal.html', rota = "/resultado",
...
@app.route('/resultado_erro')
def resultado_erro():
    return render_template('principal.html', rota = "/resultado_erro")
